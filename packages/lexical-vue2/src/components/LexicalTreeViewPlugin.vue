...
import {computed, onUnmounted, ref, watchEffect} from '@vue/composition-api'
  ...
  setup() {
    ...
    function visitTree(currentNode, visitor, indent = []) {
      ...
      childNodes.forEach((childNode, i) => {
        visitor(childNode, indent.concat(
        ...
        if ($isElementNode(childNode)) {
          visitTree(childNode, visitor, indent.concat(
              i === childNodesLength - 1
